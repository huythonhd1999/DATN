...
CREATE TABLE `Canceled_Order` (
  ...
  `notes` varchar(255) NOT NULL DEFAULT '1',
  PRIMARY KEY (`orderId`)
...
LOCK TABLES `Canceled_Order` WRITE;
/*!40000 ALTER TABLE `Canceled_Order` DISABLE KEYS */;
/*!40000 ALTER TABLE `Canceled_Order` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-07-29 23:00:41
